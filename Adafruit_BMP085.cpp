...
{ write8(BMP085_CONTROL, BMP085_READTEMPCMD);
  delay(5);
#if BMP085_DEBUG == 1
  Serial.print(F("Raw temp: "))); Serial.println(read16(BMP085_TEMPDATA));
#endif
...
#if BMP085_DEBUG == 1
  Serial.print(F("Raw pressure: ")); Serial.println(raw);
#endif
  return raw;
}
...
#if BMP085_DEBUG == 1     // use datasheet numbers!
  UT = 27898;
  UP = 23843;
  ac6 = 23153;
  ac5 = 32757;
...
#if BMP085_DEBUG == 1
  UT = 27898;       // use datasheet numbers!
  ac6 = 23153;
  ac5 = 32757;
  mc = -8711;
  md = 2868;
